...
export default function Footer() {
    return (
        ...
        >
            <p>Built by 원주연 (Juyeon Won) © 2026</p>
            <p>
                Powered by{" "}
            ...
            <p>
                Design based on{" "}
                <a href="https://github.com/fatiharapoglu/portfolio-2023" target="_blank" className="animated-link font-bold text-slate-400 transition-colors duration-300 hover:text-amber-100">
                    Fatih Arapoğlu
                </a>{" "}
                (MIT License)
            </p>
            <a href="https://github.com/1juyeon" target="_blank" className="mt-1 flex items-center justify-center gap-2 transition-colors duration-300 hover:text-amber-100">
                <span className="animated-link">View my GitHub</span>
